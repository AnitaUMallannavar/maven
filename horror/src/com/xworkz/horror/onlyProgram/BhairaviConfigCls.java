...
@Component
public class BhairaviConfigCls {

	@Override
	public String toString() {
		return "BhairaviConfigCls [name=" + name + ", age=" + age + ", location=" + location + ", phoneNo=" + phoneNo
	...
	public BhairaviConfigCls(@Value("24") int age, @Value("85487346721") long phoneNo, @Value("48.3") double weight,
