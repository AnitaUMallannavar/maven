...
public class AkshataConfigCls {
	...
	public AkshataConfigCls(@Value("21") int age, @Value("85487346721") long phoneNo,
			...
			@Value("true") boolean isLovesNature, @Value("A") char statrtName) {
		super();
