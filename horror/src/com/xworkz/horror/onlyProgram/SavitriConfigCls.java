...
@Component
public class SavitriConfigCls {

	@Override
	public String toString() {
		return "SavitriConfigCls [name=" + name + ", age=" + age + ", location=" + location + ", phoneNo=" + phoneNo
	...
	public SavitriConfigCls(@Value("26") int age, @Value("85487346721") long phoneNo, @Value("48.3") double weight,
