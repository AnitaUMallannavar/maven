...
@Component
public class NishaCls {

	@Override
	public String toString() {
		return "NishaCls [name=" + name + ", age=" + age + ", location=" + location + ", phoneNo=" + phoneNo
	...
	public NishaCls(@Value("26") int age, @Value("9576473467") long phoneNo, @Value("40.3") double weight,
		...
		super();
		System.out.println("Registering Nisha's information in AkshataConfigCla");
		this.age = age;
