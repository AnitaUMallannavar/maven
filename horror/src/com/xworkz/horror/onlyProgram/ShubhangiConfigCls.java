...
@Component
public class ShubhangiConfigCls {

	
	
	@Override
	public String toString() {
		return "AkshataConfigCls [name=" + name + ", age=" + age + ", location=" + location + ", phoneNo=" + phoneNo
	...
	public ShubhangiConfigCls(@Value("22") int age, @Value("85487346721") long phoneNo,
			@Value("48.3") double weight, @Value("4.8") double height, @Value("false") boolean working,
			@Value("true") boolean alive, @Value("false") boolean married, @Value("true") boolean isSingle,
			@Value("true") boolean isLovesNature, @Value("S") char statrtName) {
		super();
