...
@Component
public class ShaaCls {

	@Override
	public String toString() {
		return "ShaaCls [name=" + name + ", age=" + age + ", location=" + location + ", phoneNo=" + phoneNo
	...
	public ShaaCls(@Value("26") int age, @Value("9576473467") long phoneNo, @Value("40.3") double weight,
		...
		super();
		System.out.println("Registering Shaa's information in AkshataConfigCla");
		this.age = age;
